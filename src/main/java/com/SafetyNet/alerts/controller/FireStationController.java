...
public class FireStationController {
     ...
     public ResponseEntity<FireStation> updateFireStation(@PathVariable("address") String stationNumber, String stationAddress,
                @RequestBody FireStation firestation) {
                return fireStationService.updateFireStation(stationNumber, stationAddress, firestation).map(mr -> ResponseEntity.ok(mr))
