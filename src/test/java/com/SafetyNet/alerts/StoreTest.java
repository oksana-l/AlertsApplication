...
public class StoreTest {
	...
	public static Store testStore() {
		...
		Person person3 = new Person("Peter", "Duncan", "644 Gershwin Cir", "Culver", "97451", "841-874-6512", "drk@email.com");
		...
		MedicalRecord medicalRecord2 = new MedicalRecord("Jacob", "Boyd", "12/02/2010", Arrays.asList("pharmacol:5000mg", "terazine:10mg", "noznazol:250mg"), Arrays.asList());
